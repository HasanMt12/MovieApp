...
import Banner from "../../../public/mashap.mp4";
import Aos from "aos";
      ...
      <div className="secContent container">
        <div className="contactDiv flex ">
          <div data-aos="fade-up" className="text">
            ...
            <h2>Watching with us</h2>
          </div>
          <div className="inputDiv flex">
            <input className='rounded-sm' data-aos="fade-up" type="text" placeholder='Enter your email' />
            <button data-aos="fade-up" className="btn flex " type='submit'>
              SEND <FiSend className='icon hover:text-[#00ADB5]'/>
            </button>
          </div>
        </div>
        <div className="footerCard flex">
          ...
          <div className="footerLinks grid">
            ...
            <Link to="/"> <li  className="footerList flex">
                <FiChevronRight className='icon'/>
                Experience
              </li></Link> 
              <li className="footerList flex">
          ...
          <div className="footerDiv flex bg-[#00ADB5]" >
